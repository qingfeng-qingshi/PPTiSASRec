...
if __name__ == '__main__':
    ...
    if args.inference_only:
        ...
        print('test (NDCG@10: %.4f, HR@10: %.4f,P@10: %.4f R@10: %.4f)' % (t_test[0], t_test[1], t_test[2], t_test[3]))
    #二元交叉熵损失函数 Adam优化器
    ...
    for epoch in range(epoch_start_idx, args.num_epochs + 1):
        ...
        if epoch % 20 == 0:
            ...
            print('epoch:%d, time: %f(s), valid (NDCG@10: %.4f, HR@10: %.4f), test (NDCG@10: %.4f, HR@10: %.4f,P@10: %.4f R@10: %.4f)'
                    % (epoch, T, t_valid[0], t_valid[1], t_test[0], t_test[1], t_test[2], t_test[3]))
